...
$(document).ready(function() {
  ...
  console.log(revDate);
  Revenue.split(',').forEach(e => {
    revAmount.push(parseInt(e))
  });
  nOrders.split(',').forEach(e => {
    revOrder.push(parseInt(e))
  });
  /*======== 6. AREA CHART ========*/
...
let statusCount=[]
statCount.split(',').forEach(e => {
  statusCount.push(parseInt(e))
});
let statusName=[]
statName.split(',').forEach(e => {
  statusName.push(e)
});
        ...
        datasets: [
          {
            label: statusName,
            data: statusCount,
            backgroundColor: [ "blue","black", "red", "violet", "orange","green"],
            borderWidth: 1
